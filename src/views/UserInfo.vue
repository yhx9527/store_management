    ...
    <div>
        <el-row type="flex" style="margin-bottom: 30px;">
            <el-col :span="8" style="text-align: left">
                <el-button type="primary" @click="handleForm">添加新用户<i class="el-icon-circle-plus el-icon--right"></i></el-button>
            </el-col>
    ...
    export default {
        ...
        methods: {
            ...
            async querySearchAsync(queryString,cb) {
                let data = await this.$apis.user_get(this.currentPage, this.pageSize, queryString)
